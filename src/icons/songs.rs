use leptos::{
    component, create_effect, create_rw_signal, create_signal, create_write_slice,
    ev::{keydown, keypress, keyup},
    spawn_local, use_context, view, window_event_listener, ErrorBoundary, For, IntoView,
    ReadSignal, RwSignal, SignalGet, SignalSet, SignalUpdate, WriteSignal,
};
...
use crate::{
    ...
    icons::{
        ...
        play_hover_icon::PlayHoverIcon, random_icon::RandomIcon,
            ...
            <div class="d-flex h-100 w-100">
                <div class="container-fluid">
                        ...
                        <div class="row no-gutters">
                            <div class="col song-header-options w-100">
                                <div class="row no-gutters align-items-center h-100">
                                    // Sort icons here
                                    <div class="col-auto ml-auto d-flex"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row no-gutters h-100">
                        <div class="scroller w-100 full-height">
                            ...
                            <For
                                ...
                                key=|(_, song)| song.song._id.clone().unwrap()
