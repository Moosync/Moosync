...
use crate::{
    AppCallbacks, MainWindow, main_content::search::SearchPageHandler, pages::PageHandler,
    test_utils::run_async_test,
};

#[test]
#[tracing::instrument(level = "debug", skip_all)]
fn test_search_page_handler_initialize() {
    run_async_test(|| async move {
        let tmp = TempDir::new("moosync_ui_search_init").unwrap();
