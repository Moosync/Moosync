...
use crate::utils::{
    cache_image, get_safe_name, parse_color, parse_length, song_model_to_song, to_album_model,
...
fn test_to_search_result() {
    crate::test_utils::run_test(|| {
        ...
        let result = to_search_result(proto_res, None, slint::Image::default(), &theme, tmp.path());
